...
fn get_loss(grid: &Vec<Vec<u32>>) -> u32 {
    ...
    }) = heap.pop()
    {
        ...
        if cells_travelled < 10 && (delta_r, delta_c) != (0, 0) {
        ...
        if cells_travelled >= 4 || (delta_r, delta_c) == (0, 0) {
...
pub fn clumsy_crucible_two(file_name: &String) {
    let test_grid = "
    2413432311323
    3215453535623
    3255245654254
    ...
    assert!(test_score == 94, "Test Score Found: {test_score}");

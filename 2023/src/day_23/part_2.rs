...
fn get_longest_flat_distance(maze: &Vec<Vec<char>>) -> u32 {
...
pub fn a_long_walk_two(file_name: &String) {
    let test = r#"
    #.#####################
    #.......#########...###
    #######.#########.#.###
    ...
    let test_ans = get_longest_flat_distance(&test);

    assert!(test_ans == 154, "Expected 154, got {test_ans}");
    ...
    let maze = reader
        ...
        .collect();
    let ans = get_longest_flat_distance(&maze);
    println!("Answer: {ans}")
}
